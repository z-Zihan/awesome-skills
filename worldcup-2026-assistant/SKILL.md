...
- **⚠️ 单关判断必须以 sporttery.cn 官网截图为准**：500.com 的"单关0/1"标记与 sporttery 官网的"单"标记经常对不上。如果用户发了 sporttery 截图，一律按截图判断，不要用 500.com 或 zgzcw 的数据判断单关
- **赔率也以 sporttery.cn 官网为准**：zgzcw.com 有时赔率与官网不一致（如摩洛哥vs海地让球-2，zgzcw 显示 14.96/1.19/6.91 但 sporttery 官网是 2.25/3.85/2.35），以 sporttery 为准
- **胜平负开售判断**：截图里[0]有赔率=开了（可能不可单关但能串关），显示"未"或"--"=未开售。500.com 的"0"=单关0=开了不可单关，不是未开售！只有显示"未开售"才是真没开
- **单关标记位置**：sporttery 的"单"标记可能标在比分/半全场/总进球上，不是胜平负或让球！必须仔细看"单"标在哪个玩法旁边。让球单关和胜平负单关是不同的，需逐场逐玩法确认
