...
- **让球玩法规则（2026-06-29 全面总结，禁止再搞混）**：
  - 口诀：让球方减让球数，受让方加让球数。加减后看主队赢/平/输→让胜/让平/让负
  - **让N球（主队-N）**：主队赢N+1球以上→让胜 | 主队恰好赢N球→让平 | 主队赢不到N球/平/输→让负
  - **受让N球（主队+N）**：主队赢/平/输不到N球→让胜 | 主队恰好输N球→让平 | 主队输N+1球以上→让负
  - ⚠️ **让-1让负 = 主队平或输，不是「赢不到2个」！** 赢不到2个 = 让平+让负的组合
  - ⚠️ **「强队赢不多」不等于让负！** 想表达「强队赢不多」应该买让平（恰好赢让球数），不能只买让负
  - 让-1举例：主队2:0→让胜 | 主队1:0→让平 | 主队0:0或0:1→让负
  - 受让+1举例：主队1:0或0:0→让胜 | 主队0:1→让平 | 主队0:2→让负
  - 让-2举例：主队3:0→让胜 | 主队2:0→让平 | 主队1:0或0:0→让负
  - 受让+2举例：主队1:0或0:0或0:1→让胜 | 主队0:2→让平 | 主队0:3→让负
  - ❌ 2026-06-29 连续两次把让负写成「赢不到2个」，实际让负=平或输
  - ❌ 2026-06-27 把让胜让负写反（弱队受让后不输=让胜，不是让负）
  - **详细表格和所有情况见 `LOTTERY-GUIDE.md` 让球玩法完整规则**
