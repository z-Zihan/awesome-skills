...
大学英语水平（CEFR B1-C1）交互式快速测评。随机生成题卷（20-40题，6-8种题型，满分100分），12种题型覆盖词汇翻译、语法填空、选择题、句子改错、阅读理解、中译英翻译、同义词替换等。内容覆盖各专业领域（科技、医学、法律、金融、文学等）。全程静默判分，完成后输出得分与弱项分析报告。

**触发词**：开始英语测评 / 英语测试 / 测一下英语 / 英语水平测评
