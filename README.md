...
商务英语/大学一至二年级水平，交互式快速测评。6种题型：EN→CN词汇翻译、CN→EN词汇翻译、语法填空、选择题、商务场景翻译、阅读理解。每次一道题，用户作答后即时反馈，30题约20分钟，满分100分，完成后输出得分与弱项分析报告。

**触发词**：开始英语测评 / 英语测试 / 测一下英语 / English assessment / test my English
